    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-8 bg-gradient-to-b from-white to-rose-50/30">
        <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} className="w-full max-w-md">
          ...
          {registered && <motion.div initial={{opacity:0}} animate={{opacity:1}} className="bg-emerald-50 border border-emerald-200 text-emerald-700 px-4 py-3 rounded-xl text-sm mb-4 flex items-center gap-2"><Sparkles className="w-4 h-4" /> Account created! Sign in to get started.</motion.div>}
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                {identifier.includes("@") && !identifier.includes(".") ? <AtSign className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" /> : <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />}
              </div>
            </div>
          ...
          <div className="mt-6 text-center space-y-3">
            <p className="text-sm text-gray-500">Do not have an account? <Link href="/signup" className="text-rose-500 font-semibold hover:underline">Create Account</Link></p>
          </div>
        </motion.div>
      </div>
    </div>
