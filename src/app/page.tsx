    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <a href="#testimonials" className="text-gray-600 hover:text-rose-600 text-sm font-medium transition-colors">Success Stories</a>
            </div>
      ...
      <section id="pricing" className="py-16 sm:py-24 bg-gradient-to-b from-rose-50/30 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">One-Time Payment,</h2>
            <p className="text-gray-500 max-w-xl mx-auto text-sm sm:text-base">No subscriptions. No hidden fees. Pay once, keep forever.</p>
      ...
      <section id="testimonials" className="py-16 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Real Couples,</h2>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-r from-rose-500 via-pink-500 to-purple-500">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">Your Perfect Match is Waiting</h2>
          <p className="text-lg text-rose-100 mb-8 max-w-2xl mx-auto">Join thousands of verified singles finding real love on ConnectHub.</p>
