          ...
          <div className={(dc ? "bg-gray-800 border-gray-700" : "bg-white border-gray-100") + " rounded-2xl border shadow-sm overflow-hidden"}>
            ...
            <div className={"px-6 py-4 border-t " + (dc ? "border-gray-700 bg-gray-800/50" : "border-gray-100 bg-gray-50/50")}>
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between items-center"><span className={"text-xs " + (dc?"text-gray-400":"text-gray-500")}>Email Verified</span>{settings.emailVerified ? <span className="text-xs font-semibold text-green-500">Verified ✓</span> : <a href="/verify-email" className="text-[10px] font-bold px-3 py-1 bg-rose-500 text-white rounded-full hover:bg-rose-600 transition-all">Verify Now</a>}</div>
                <div className="flex justify-between items-center"><span className={"text-xs " + (dc?"text-gray-400":"text-gray-500")}>Phone Verified</span>{settings.phoneVerified ? <span className="text-xs font-semibold text-green-500">Verified ✓</span> : settings.phone ? <a href="/verify-email" className="text-[10px] font-bold px-3 py-1 bg-rose-500 text-white rounded-full hover:bg-rose-600 transition-all">Verify Now</a> : <span className={"text-xs font-semibold " + (dc?"text-gray-400":"text-amber-500")}>No phone added</span>}</div>
