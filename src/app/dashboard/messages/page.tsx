    ...
    return (
      <div className="flex flex-col h-[calc(100vh-8rem)]">
        ...
        <div className={"flex items-center gap-3 p-4 border-b " + (dc?"bg-gray-800 border-gray-700":"bg-white border-gray-100")}>
          ...
          <Link href={"/dashboard/video"} className={"p-2.5 rounded-lg " + (dc?"hover:bg-gray-700 text-gray-400":"hover:bg-gray-100 text-gray-500")}><Phone className="w-5 h-5" /></Link>
          <Link href={"/dashboard/video"} className={"p-2.5 rounded-lg " + (dc?"hover:bg-gray-700 text-gray-400":"hover:bg-gray-100 text-gray-500")}><Video className="w-5 h-5" /></Link>
        </div>
