...
import { Heart, MessageCircle, Send, Image as ImageIcon, Smile, Trash2, X, Film, Shield, Share2 } from "lucide-react";
...
export default function FeedPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-0 sm:px-4">
      ...
      {/* ═══ CREATE POST ═══ */}
      <div className={"rounded-2xl border mx-4 sm:mx-0 p-4 sm:p-5 mb-5 mt-4 " + (dc ? "bg-gray-800 border-gray-700" : "bg-white border-gray-100 shadow-sm")}>
