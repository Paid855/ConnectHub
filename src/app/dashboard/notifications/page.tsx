  ...
  return (
    <div className={"max-w-2xl mx-auto " + (dc ? "text-white" : "")}>
      ...
      <div className="flex gap-2 overflow-x-auto pb-3 mb-4">
        {[{ k:"all", label:"All", count:notifs.length }, { k:"unread", label:"Unread", count:unreadCount }, { k:"match", label:"Matches" }, { k:"like", label:"Likes" }, { k:"message", label:"Messages" }, { k:"gift", label:"Gifts" }].map(f => (
